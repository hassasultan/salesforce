                                ...
                                <div class="form-row">
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="slider_heading" id="validationTooltip02"
                                            placeholder="Place Heading" required value="{{ old('slider_heading') }}">
                                    </div>
                                    <div class="col-12 mb-3">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <textarea class="form-control summernote" name="slider_description" id="exampleFormControlTextarea1" rows="3" placeholder="Description">{{ old('slider_description') }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="card p-3 mb-3">
                                ...
                                <div class="form-row">
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="content_left_heading" id="validationTooltip02"
                                            placeholder="Place Heading" required value="{{ old('content_left_heading') }}">
                                    </div>
                                    <div class="col-12 mb-3">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <textarea class="form-control summernote" name="content_left_description" id="exampleFormControlTextarea1" rows="3" placeholder="Description">{{ old('content_left_description') }}</textarea>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="content_right_heading" id="validationTooltip02"
                                            placeholder="Place Heading" required value="{{ old('content_right_heading') }}">
                                    </div>
                                    <div class="col-12 mb-3">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <textarea class="form-control summernote" name="content_right_description" id="exampleFormControlTextarea1" rows="3" placeholder="Description">{{ old('content_right_description') }}</textarea>
                                    </div>
                                </div>
                            </div>
